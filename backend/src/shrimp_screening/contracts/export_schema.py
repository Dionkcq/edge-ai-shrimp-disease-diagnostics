...
SCHEMA_ARTIFACTS: tuple[SchemaArtifact, ...] = (
    ...
    SchemaArtifact(
        relative_path="contracts/advice_document.schema.json",
        model=AdviceDocument,
        schema_id="https://shrimp-screening.invalid/schemas/advice_document.schema.json",
        description=(
            "Response body of GET /api/v1/advice/{decision}, an optional endpoint "
            "generated by a local Ollama model and disabled by default. Generated from "
            "backend/src/shrimp_screening/contracts/advice.py; do not hand-edit."
        ),
    ),
)
