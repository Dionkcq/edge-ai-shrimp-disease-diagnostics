...
export function fixtureAdvice(): Advice {
  return {
    decision: 'MULTIPLE_TARGET_MARKERS_DETECTED',
    summary: 'Two marker types were visible in this photograph. This is not a diagnosis.',
    immediate_actions: ['Photograph several more animals from the same pond.'],
    prevention_actions: ['Keep the stocking density and water exchange consistent.'],
    additional_considerations: ['Ask a qualified professional before acting on this.'],
    based_on_guidance_id: 'guide-v1',
    sources: [
      {
        id: 'woah',
        title: 'Aquatic Manual',
    ...
    review_note:
      'Generated by a local language model from the cited guidance and not reviewed by a professional.',
    limitations: ['lim-not-diagnostic'],
  }
}

export function fixtureAdviceProblem(): Problem {
  return {
    type: '/problems/advice-unavailable',
    title: 'Advice unavailable',
    status: 503,
    detail: 'Local advice generation is temporarily unavailable.',
